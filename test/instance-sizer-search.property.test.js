...
describe('Feature: mcp-catalog-consolidation, Property 6: CUDA version filtering', function () {
    ...
    it('all instances returned by filterByCudaVersion have compatible CUDA versions', function () {
    ...
    it('filterByCudaVersion never returns instances without cudaVersions', function () {
...
describe('Feature: mcp-catalog-consolidation, Property 7: Tag-based search filtering', function () {
    ...
    it('every instance returned by searchInstancesByTag matches at least one search token', function () {
    ...
    it('searchInstancesByTag returns empty array for nonsense queries', function () {
    ...
    it('multi-gpu search only returns instances with gpus > 1', function () {
...
describe('Feature: mcp-catalog-consolidation, Property 8: Combined VRAM + search filtering', function () {
    ...
    it('combined filtering respects both VRAM and tag constraints', function () {
