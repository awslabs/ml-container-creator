...
describe('Feature: mcp-catalog-consolidation, Property 5: Architecture-based heuristic fallback correctness', function () {
    ...
    it('for any known architecture, returns the correct heuristic default', function () {
    ...
    it('for unknown architectures, falls back to ml.g5.xlarge', function () {
    ...
    it('transformer architectures always get GPU instances', function () {
    ...
    it('predictor architectures always get CPU instances', function () {
