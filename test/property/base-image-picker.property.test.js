...
/** A supported transformer framework key */
const arbTransformerFramework = fc.constantFrom(...Object.keys(TRANSFORMER_IMAGE_CATALOG))
...
<<<<<<< HEAD
            ...
            const dockerRefPattern = /^[a-zA-Z0-9._\-/:]+:[a-zA-Z0-9._\-]+$/
