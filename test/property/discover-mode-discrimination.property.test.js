...
describe('Feature: mcp-catalog-consolidation, Property 9: Discover mode source discrimination', function () {
    ...
    it('HuggingFace pattern matches org/model-name format (exactly one slash)', function () {
    ...
    it('protocol-prefixed models never match HuggingFace pattern', function () {
    ...
    it('models with zero slashes do not match HuggingFace pattern', function () {
    ...
    it('models with multiple slashes do not match HuggingFace pattern', function () {
    ...
    it('null and empty strings do not match', function () {
        assert.ok(!isHuggingFacePattern(null))
        assert.ok(!isHuggingFacePattern(''))
        assert.ok(!isHuggingFacePattern(undefined))
    })

    it('specific protocol prefixes are correctly excluded', function () {
        const testCases = [
    ...
    it('valid HuggingFace model IDs are correctly identified', function () {
        const testCases = [
