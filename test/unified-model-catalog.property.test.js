...
describe('Feature: mcp-catalog-consolidation, Property 2: Unified catalog schema validity', function () {
    ...
    it('every entry in models.json has a valid modelType', function () {
    ...
    it('every entry in models.json has a non-empty tasks array', function () {
        const entries = Object.entries(modelsJson)
    ...
    it('every entry in models.json has an architecture field (string or null)', function () {
        const entries = Object.entries(modelsJson)
...
describe('Feature: mcp-catalog-consolidation, Property 1: Unified catalog field completeness', function () {
    ...
    it('model-sizes fields are merged into matching models.json entries', function () {
